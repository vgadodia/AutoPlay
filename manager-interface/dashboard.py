...
spotify = spotipy.Spotify(auth = "BQD7Y2X5j7iTIGhf2K5AK_2lD1LtYcAKd-_nle1zSZCyxMvJ7v99EuP8ldHGi0HlxWmDnK0jDYa3rq0hV3kAdtKnOrnqz7JuBhx9evhUob9XoF2JkTJVbAo9F85bVF4fFbKM_yStPM32JD1vv2eb5S32brHRRaLFtnvyyNShzBnA4mSeL5CRk1yrUIob0P4JgZtO2VMbZqV-yogkZShxbrc-SxO--Zq4fFFmenAzv8yezNhJnhMuoxYzHSLnKF_X3CFVdLebUEVHdejCqK8NvsF7jivJvzjjApAI", auth_manager=SpotifyClientCredentials(client_id="fad87bdadeee4f18951a371b520b9cec", client_secret="1aae5a1dec8f4eca8a14ae055406acd6"))
...
class Worker(QObject):
    ...
    def do_work(self):
        global g_genre
        while True:
            #genre = self.button.currentIndex()
